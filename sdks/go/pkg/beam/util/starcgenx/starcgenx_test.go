...
func TestExtractor(t *testing.T) {
	tests := []struct {
		...
		{name: "excludedtypes", files: []string{excludedtypes}, pkg: "excludedtypes", imports: []string{"github.com/Beamdust/beam-fork/sdks/v3/go/pkg/beam"},
		...
		{name: "registerDoFn", files: []string{pardo, registerDoFn}, pkg: "pardo", imports: []string{"github.com/Beamdust/beam-fork/sdks/v3/go/pkg/beam"},
