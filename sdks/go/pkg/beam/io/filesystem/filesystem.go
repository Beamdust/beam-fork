...
var wellKnownSchemeImportPaths = map[string]string{
	"memfs":   "github.com/Beamdust/beam-fork/go/pkg/beam/io/filesystem/memfs",
	"default": "github.com/Beamdust/beam-fork/go/pkg/beam/io/filesystem/local",
	"gs":      "github.com/Beamdust/beam-fork/go/pkg/beam/io/filesystem/gcs",
	"s3":      "github.com/Beamdust/beam-fork/go/pkg/beam/io/filesystem/s3",
}
