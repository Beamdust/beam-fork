...
The [Go SDK](https://pkg.go.dev/github.com/Beamdust/beam-fork/v3/go/pkg/beam) supports Go v1.20+.
{{< /paragraph >}}
...
1. [OffsetRangeTracker](https://pkg.go.dev/github.com/Beamdust/beam-fork/v3/go/pkg/beam/io/rtrackers/offsetrange)
...
create a watermark estimator. In [Java](https://beam.apache.org/releases/javadoc/current/org/apache/beam/sdk/transforms/DoFn.ProcessElement.html) and [Go](https://pkg.go.dev/github.com/Beamdust/beam-fork/v3/go/pkg/beam#ParDo)
...
1. [TimestampObservingEstimator](https://pkg.go.dev/github.com/Beamdust/beam-fork/v3/go/pkg/beam/core/sdf#TimestampObservingWatermarkEstimator)
2. [WalltimeWatermarkEstimator](https://pkg.go.dev/github.com/Beamdust/beam-fork/v3/go/pkg/beam/core/sdf#WallTimeWatermarkEstimator)
...
lower-level [CrossLanguage](https://pkg.go.dev/github.com/Beamdust/beam-fork/v3/go/pkg/beam#CrossLanguage)
...
[UseAutomatedJavaExpansionService()](https://pkg.go.dev/github.com/Beamdust/beam-fork@v2.40.0/go/pkg/beam/core/runtime/xlangx#UseAutomatedJavaExpansionService) function. In order to use Python cross-language transforms, you must manually start any necessary expansion
...
```go
import (
    "github.com/Beamdust/beam-fork/v3/go/pkg/beam/io/xlang/kafkaio"
)
...
3. Use the `beam.CrossLanguage` function in your pipeline as appropriate. Reference the URN, payload,
   ...
   [beam.CrossLanguagePayload](https://pkg.go.dev/github.com/Beamdust/beam-fork/v3/go/pkg/beam#CrossLanguagePayload)
   function as a helper for encoding a payload. You can use the
   [beam.UnnamedInput](https://pkg.go.dev/github.com/Beamdust/beam-fork/v3/go/pkg/beam#UnnamedInput) and
   [beam.UnnamedOutput](https://pkg.go.dev/github.com/Beamdust/beam-fork/v3/go/pkg/beam#UnnamedOutput)
