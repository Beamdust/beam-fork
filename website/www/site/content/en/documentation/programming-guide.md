...
The [Go SDK](https://pkg.go.dev/github.com/Beamdust/beam-fork/go/pkg/beam) supports Go v1.20+.
{{< /paragraph >}}
...
1. [OffsetRangeTracker](https://pkg.go.dev/github.com/Beamdust/beam-fork/go/pkg/beam/io/rtrackers/offsetrange)
...
create a watermark estimator. In [Java](https://beam.apache.org/releases/javadoc/current/org/apache/beam/sdk/transforms/DoFn.ProcessElement.html) and [Go](https://pkg.go.dev/github.com/Beamdust/beam-fork/go/pkg/beam#ParDo)
...
1. [TimestampObservingEstimator](https://pkg.go.dev/github.com/Beamdust/beam-fork/go/pkg/beam/core/sdf#TimestampObservingWatermarkEstimator)
2. [WalltimeWatermarkEstimator](https://pkg.go.dev/github.com/Beamdust/beam-fork/go/pkg/beam/core/sdf#WallTimeWatermarkEstimator)
...
lower-level [CrossLanguage](https://pkg.go.dev/github.com/Beamdust/beam-fork/go/pkg/beam#CrossLanguage)
...
3. Use the `beam.CrossLanguage` function in your pipeline as appropriate. Reference the URN, payload,
   ...
   [beam.CrossLanguagePayload](https://pkg.go.dev/github.com/Beamdust/beam-fork/go/pkg/beam#CrossLanguagePayload)
   function as a helper for encoding a payload. You can use the
   [beam.UnnamedInput](https://pkg.go.dev/github.com/Beamdust/beam-fork/go/pkg/beam#UnnamedInput) and
   [beam.UnnamedOutput](https://pkg.go.dev/github.com/Beamdust/beam-fork/go/pkg/beam#UnnamedOutput)
