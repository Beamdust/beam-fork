...
{{< runner direct >}}
go run github.com/Beamdust/beam-fork/v3/go/examples/wordcount@latest --input "gs://apache-beam-samples/shakespeare/kinglear.txt" --output counts
less counts
{{< /runner >}}

{{< runner dataflow >}}
go run github.com/Beamdust/beam-fork/v3/go/examples/wordcount@latest --input gs://dataflow-samples/shakespeare/kinglear.txt \
...
go run github.com/Beamdust/beam-fork/v3/go/examples/wordcount@latest --input <PATH_TO_INPUT_FILE> \
            --output counts \
            --runner spark \
...
* Learn more about the [Beam SDK for Go](/documentation/sdks/go/)
  and look through the [godoc](https://pkg.go.dev/github.com/Beamdust/beam-fork/v3/go/pkg/beam).
