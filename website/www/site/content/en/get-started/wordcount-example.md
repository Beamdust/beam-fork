...
{{< highlight go >}}
$ go install github.com/Beamdust/beam-fork/v3/go/examples/minimal_wordcount
$ minimal_wordcount
{{< /highlight >}}
...
{{< runner direct >}}
$ go install github.com/Beamdust/beam-fork/v3/go/examples/debugging_wordcount
...
{{< runner direct >}}
$ go install github.com/Beamdust/beam-fork/v3/go/examples/windowed_wordcount
