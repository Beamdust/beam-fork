...
{{< highlight go >}}
$ go install github.com/Beamdust/beam-fork/go/examples/minimal_wordcount
$ minimal_wordcount
{{< /highlight >}}
...
{{< runner direct >}}
$ go install github.com/Beamdust/beam-fork/go/examples/wordcount
...
{{< runner direct >}}
$ go install github.com/Beamdust/beam-fork/go/examples/debugging_wordcount
...
{{< runner direct >}}
$ go install github.com/Beamdust/beam-fork/go/examples/windowed_wordcount
